...
def visual(img_path,label_path,pred_path):
    ...
    image = Image.blend(image,image3,0.1)
...
if __name__ == "__main__":
    ...
    pred_base = '/data/dataset/lhq/PNSNet/res/PNS-Net_ours/hard/Pred/'
    # out = '/data/dataset/lhq/PNSNet/res/PNS-Net/hard/Pred_draw/'
    out = '/data/dataset/lhq/PNSNet/res/PNS-Net_ours/hard/Pred_draw/'
    ...
    for path in path_list:
        ...
        image_index.sort(key=lambda x: int(x[-7:-4]))  # 文件名按数字排序
